								...
								if (NodeHelper.getType(replicate).equals("Replicate"))
								{
									...
									if(replicate.hasProperty("D4-DES"))
									{
										...
										if(!Double.isNaN(tmp) && tmp > 0)
										{
											...
											replicate.setProperty("Ratio DES", (desTmp - tmp*ratioDes) / tmp );
										}
									}
									...
									if(replicate.hasProperty("D4-HP"))
									{
										...
										if(!Double.isNaN(tmp) && tmp > 0)
										{
											...
											replicate.setProperty("Ratio HP", (hpTmp - tmp*ratioHp) / tmp );
											replicate.setProperty("Ratio LP", (lpTmp - tmp*ratioHp) / tmp );
										}
									}
									//Replicate
								}
